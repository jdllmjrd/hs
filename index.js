...
app.use(
  "/users-profile-pic",
  express.static(
    path.join(__dirname + "./backend/src/public/users_profile_pic")
  )
);
app.use(
  "/featured_dentist",
  express.static(path.join(__dirname + "./backend/src/public/featured_dentist"))
);
app.use(
  "/services",
  express.static(path.join(__dirname + "./backend/src/public/services"))
);
// Home page
app.use(
  `${process.env.API_VERSION}/home`,
  require("./backend/src/routes/home.routes")
);
// Register Page
app.use(
  `${process.env.API_VERSION}/register`,
  require("./backend/src/routes/register.routes")
);
// For log in page
app.use(
  `${process.env.API_VERSION}/login`,
  require("./backend/src/routes/login.routes")
);
//Service page
app.use(
  `${process.env.API_VERSION}/services`,
  require("./backend/src/routes/service.routes")
);
...
app.use(
  ...
  authenticateToken,
  require("./backend/src/routes/dentist.routes")
);
...
app.use(
  ...
  authenticateToken,
  require("./backend/src/routes/admin.routes")
);
