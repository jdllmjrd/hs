 ...
 */
 ...
 exports.updateService = (req, res) => {
    ...
    req.body.services_image = req.file != undefined ? req.file.filename : "";
     ...
     Services.update(req.body, { where: { services_id: services_id }}, { include: ["admin_updated_services"] })
     .then((result) => {
       console.log(req.body);
       if (result) {
         // retrieve updated details
         Users.findByPk(data.users_id, { include: ["admin_updated_services"] }).then((result) => {
           res.send({
             error: false,
             data: result,
