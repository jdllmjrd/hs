        ...
        <div class="wrapper">
            ...
            <div class="leftside-menu">
                ...
                <a href="index.html" class="logo text-center logo-light">
                    <span class="logo-lg">
                        <img src="<?php echo base_url('frontend/assets')?>/images/logo.png" alt="" height="16">
                    </span>
                    <span class="logo-sm">
                        <img src="<?php echo base_url('frontend/assets')?>/images/logo_sm.png" alt="" height="16">
                    </span>
                </a>
                ...
                <a href="index.html" class="logo text-center logo-dark">
                    <span class="logo-lg">
                        <img src="<?php echo base_url('frontend/assets')?>/images/logo-dark.png" alt="" height="16">
                    </span>
                    <span class="logo-sm">
                        <img src="<?php echo base_url('frontend/assets')?>/images/logo_sm_dark.png" alt="" height="16">
                    </span>
                </a>
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar="">
                    ...
                    <div class="help-box text-white text-center">
                        ...
                        <img src="<?php echo base_url('frontend/assets')?>/images/help-icon.svg" height="90" alt="Helper Icon Image">
                    ...
                    <div class="navbar-custom">
                        <ul class="list-unstyled topbar-menu float-end mb-0">
                            ...
                            <li class="dropdown notification-list topbar-dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                    <img src="<?php echo base_url('frontend/assets')?>/images/flags/us.jpg" alt="user-image" class="me-0 me-sm-1" height="12"> 
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <img src="<?php echo base_url('frontend/assets')?>/images/flags/germany.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">German</span>
                                    </a>

                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <img src="<?php echo base_url('frontend/assets')?>/images/flags/italy.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Italian</span>
                                    </a>
                
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <img src="<?php echo base_url('frontend/assets')?>/images/flags/spain.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Spanish</span>
                                    </a>

                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <img src="<?php echo base_url('frontend/assets')?>/images/flags/russia.jpg" alt="user-image" class="me-1" height="12"> <span class="align-middle">Russian</span>
                                    </a>
                                    ...
                                    <div style="max-height: 230px;" data-simplebar="">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon">
                                                <img src="<?php echo base_url('frontend/assets')?>/images/users/avatar-2.jpg" class="img-fluid rounded-circle" alt=""> </div>
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon">
                                                <img src="<?php echo base_url('frontend/assets')?>/images/users/avatar-4.jpg" class="img-fluid rounded-circle" alt=""> </div>
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                    <span class="account-user-avatar"> 
                                        <img src="<?php echo base_url('frontend/assets')?>/images/users/avatar-1.jpg" alt="user-image" class="rounded-circle">
                                    </span>
                                    <span>
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-5">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <img src="<?php echo base_url('frontend/assets')?>/images/users/avatar-1.jpg" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="inbox-widget">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="<?php echo base_url('frontend/assets')?>/images/users/avatar-2.jpg" class="rounded-circle" alt=""></div>
                                            ...
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="<?php echo base_url('frontend/assets')?>/images/users/avatar-3.jpg" class="rounded-circle" alt=""></div>
                                            ...
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="<?php echo base_url('frontend/assets')?>/images/users/avatar-4.jpg" class="rounded-circle" alt=""></div>
                                            ...
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="<?php echo base_url('frontend/assets')?>/images/users/avatar-5.jpg" class="rounded-circle" alt=""></div>
                                            ...
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="<?php echo base_url('frontend/assets')?>/images/users/avatar-6.jpg" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-borderless table-nowrap mb-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>1</td>
                                                                <td><img src="<?php echo base_url('frontend/assets')?>/images/users/avatar-2.jpg" alt="table-user" class="me-2 rounded-circle" height="24"> Halette Boivin</td>
                                                            ...
                                                            <tr>
                                                                <td>2</td>
                                                                <td><img src="<?php echo base_url('frontend/assets')?>/images/users/avatar-3.jpg" alt="table-user" class="me-2 rounded-circle" height="24"> Durandana Jolicoeur</td>
                                                            ...
                                                            <tr>
                                                                <td>3</td>
                                                                <td><img src="<?php echo base_url('frontend/assets')?>/images/users/avatar-4.jpg" alt="table-user" class="me-2 rounded-circle" height="24"> Lucas Sabourin</td>
                                                            ...
                                                            <tr>
                                                                <td>4</td>
                                                                <td><img src="<?php echo base_url('frontend/assets')?>/images/users/avatar-6.jpg" alt="table-user" class="me-2 rounded-circle" height="24"> Donatien Brunelle</td>
                                                            ...
                                                            <tr>
                                                                <td>5</td>
                                                                <td><img src="<?php echo base_url('frontend/assets')?>/images/users/avatar-5.jpg" alt="table-user" class="me-2 rounded-circle" height="24"> Karel Auberjo</td>
                                            ...
                                            <div class="tab-pane show active" id="timeline">
                                                ...
                                                <div class="border border-light rounded p-2 mb-3">
                                                    <div class="d-flex">
                                                        <img class="me-2 rounded-circle" src="<?php echo base_url('frontend/assets')?>/images/users/avatar-3.jpg" alt="Generic placeholder image" height="32">
                                                        <div>
                                                    ...
                                                    <img src="<?php echo base_url('frontend/assets')?>/images/small/small-1.jpg" alt="post-img" class="rounded me-1" height="60">
                                                    <img src="<?php echo base_url('frontend/assets')?>/images/small/small-2.jpg" alt="post-img" class="rounded me-1" height="60">
                                                    <img src="<?php echo base_url('frontend/assets')?>/images/small/small-3.jpg" alt="post-img" class="rounded" height="60">
                                                ...
                                                <div class="border border-light rounded p-2 mb-3">
                                                    <div class="d-flex">
                                                        <img class="me-2 rounded-circle" src="<?php echo base_url('frontend/assets')?>/images/users/avatar-4.jpg" alt="Generic placeholder image" height="32">
                                                        <div>
                                                    ...
                                                    <div class="mx-n2 p-2 mt-3 bg-light">
                                                        <div class="d-flex">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="d-flex mt-3">
                                                                    <a class="pe-2" href="#">
                                                                        <img src="<?php echo base_url('frontend/assets')?>/images/users/avatar-4.jpg" class="rounded-circle" alt="Generic placeholder image" height="32">
                                                                    </a>
                                                                    <div>
                                                        ...
                                                        <div class="d-flex mt-2">
                                                            <a class="pe-2" href="#">
                                                                <img src="<?php echo base_url('frontend/assets')?>/images/users/avatar-1.jpg" class="rounded-circle" alt="Generic placeholder image" height="32">
                                                            </a>
                                                            <div class="w-100">
                                                ...
                                                <div class="border border-light p-2 mb-3">
                                                    <div class="d-flex">
                                                        <img class="me-2 rounded-circle" src="<?php echo base_url('frontend/assets')?>/images/users/avatar-6.jpg" alt="Generic placeholder image" height="32">
                                                        <div>
