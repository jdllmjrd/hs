        ...
        <div class="wrapper">
            ...
            <!-- ============================================================== -->
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-4">
                                <a href="admin-add-branch.php" class="btn btn-danger btn-rounded mb-3"><i class="mdi mdi-plus"></i> Add Branch</a>
                            </div><!-- end col-->
                        </div> 
                        <!-- end row-->
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <!-- project-thumbnail -->
                                    <img class="card-img-top" src="../../../assets/images/projects/1.jpg" alt="project image cap">
                                    ...
                                    <div class="card-body position-relative">
                                        <!-- project title-->
                                        <h4 class="mt-0">
                                            <a href="apps-projects-details.html" class="text-title">Fairview Branch</a>
                                        </h4>
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <!-- project-thumbnail -->
                                    <img class="card-img-top" src="../../../assets/images/projects/2.jpg" alt="project image cap">
                                    <div class="card-img-overlay">
                                        <div class="badge bg-secondary text-light p-1">Ongoing</div>
                                    </div>
                                    ...
                                    <div class="card-body position-relative">
                                        <!-- project title-->
                                        <h4 class="mt-0">
                                            <a href="apps-projects-details.html" class="text-title">Commonwealth Branch</a>
                                        </h4>
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <!-- project-thumbnail -->
                                    <img class="card-img-top" src="../../../assets/images/projects/3.jpg" alt="project image cap">
                                    <div class="card-img-overlay">
                                        <div class="badge bg-secondary text-light p-1">Ongoing</div>
                                    </div>
                                    ...
                                    <div class="card-body position-relative">
                                        <!-- project title-->
                                        <h4 class="mt-0">
                                            <a href="apps-projects-details.html" class="text-title">MRT Shaw Branch</a>
                                        </h4>
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <!-- project-thumbnail -->
                                    <img class="card-img-top" src="../../../assets/images/projects/4.jpg" alt="project image cap">
                                    <div class="card-img-overlay">
                                        <div class="badge bg-secondary text-light p-1">Ongoing</div>
                                    </div>
                                    ...
                                    <div class="card-body position-relative">
                                        <!-- project title-->
                                        <h4 class="mt-0">
                                            <a href="apps-projects-details.html" class="text-title">Pasay Branch</a>
                                        </h4>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <!-- project-thumbnail -->
                                    <img class="card-img-top" src="../../../assets/images/projects/5.jpg" alt="project image cap">
                                    <div class="card-img-overlay">
                                        <div class="badge bg-secondary text-light p-1">Ongoing</div>
                                    </div>
                                    ...
                                    <div class="card-body position-relative">
                                        <!-- project title-->
                                        <h4 class="mt-0">
                                            <a href="apps-projects-details.html" class="text-title">Sta. Lucia Mall Branch</a>
                                        </h4>
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <!-- project-thumbnail -->
                                    <img class="card-img-top" src="../../../assets/images/projects/6.jpg" alt="project image cap">
                                    <div class="card-img-overlay">
                                    ...
                                    <div class="card-body position-relative">
                                        <!-- project title-->
                                        <h4 class="mt-0">
                                            <a href="apps-projects-details.html" class="text-title">Ayala Vertis North Branch</a>
                                        </h4>
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <!-- project-thumbnail -->
                                    <img class="card-img-top" src="../../../assets/images/projects/7.jpg" alt="project image cap">
                                    <div class="card-img-overlay">
                                        <div class="badge bg-secondary text-light p-1">Ongoing</div>
                                    </div>
                                    ...
                                    <div class="card-body position-relative">
                                        <!-- project title-->
                                        <h4 class="mt-0">
                                            <a href="apps-projects-details.html" class="text-title">Eastwood - Libis Branch</a>
                                        </h4>
                            ...
                            <div class="col-md-6 col-xxl-3">
                                ...
                                <div class="card d-block">
                                    <!-- project-thumbnail -->
                                    <img class="card-img-top" src="../../../assets/images/projects/8.jpg" alt="project image cap">
                                    <div class="card-img-overlay">
                                        <div class="badge bg-secondary text-light p-1">Ongoing</div>
                                    </div>
                                    ...
                                    <div class="card-body position-relative">
                                        <!-- project title-->
                                        <h4 class="mt-0">
                                            <a href="apps-projects-details.html" class="text-title">Ali Mall Cubao Branch</a>
                                        </h4>
